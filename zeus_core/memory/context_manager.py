...
class ContextManager:
    ...
    def __init__(self):
        self.arch_decisions_path = os.path.join(os.getenv("ZEUS_VAULT_PATH", "."), "architecture_decisions.md")
    ...
    async def assemble_full_prompt(self, session_id: str, current_message: str, 
                                   system_prompt: str, vector_memory_query: str = "") -> list:
        """
