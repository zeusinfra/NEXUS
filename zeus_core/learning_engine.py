...
class LearningEngine:
    ...
    def calculate_reward(
        ...
        rollback_cost = (
            1.0 if execution_result.get("rollback_triggered", False) else 0.0
        )
    ...
    def update_strategy(self, strategy_type: str, reward: float):
        ...
        self.save_weights()
        self.logger.info(
            f"Strategy {strategy_type} updated. New weight: {self.weights[strategy_type]:.4f} (Reward: {reward:.2f})"
        )
