...
from nexus_core.cognitive.planner import CognitivePlanner
...
from nexus_core.cognitive.user_profile_engine import UserProfileEngine
from nexus_core.cognitive.attention_engine import AttentionEngine
...
class CognitiveLoop:
    ...
    def __init__(self, db_path: str | None = None) -> None:
        ...
        from nexus_core.cognitive.self_healing import SelfHealingEngine

        self.self_healing = SelfHealingEngine(db_path=db_path)

        # New Observer Agent
        from nexus_core.core_system import ObserverAgent
