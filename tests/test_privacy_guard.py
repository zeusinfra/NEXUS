...
class TestPrivacyGuard:
    ...
    def test_classification_sensitive(self, guard):
        assert guard.classify_content("My long note about systems") == PrivacyLevel.LOCAL_SENSITIVE

    def test_classification_highly_sensitive(self, guard):
        assert guard.classify_content("Detected user habits for the day") == PrivacyLevel.HIGHLY_SENSITIVE
        assert guard.classify_content("Path: /home/zeus/.ssh/id_rsa") == PrivacyLevel.HIGHLY_SENSITIVE

    def test_classification_secret(self, guard):
        # OpenAI Key
        assert guard.classify_content("Key: sk-abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234") == PrivacyLevel.SECRET
        # Generic Secret
        assert guard.classify_content("API_KEY='supersecretpassword'") == PrivacyLevel.SECRET
    ...
    def test_audit_logs(self, guard):
        guard.validate_export("Secret sk-abcd1234abcd1234abcd1234abcd1234abcd1234abcd1234", "gemini")
