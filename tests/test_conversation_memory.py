...
def test_conversation_memory_recalls_recent_and_similar(tmp_path):
    ...
    memory.add_turn("s2", "gtk", "user", "A memoria das conversas precisa lembrar assuntos parecidos")

    block = memory.build_context_block("melhorar memoria conversa parecida", session_id="s1", client_id="gtk")
