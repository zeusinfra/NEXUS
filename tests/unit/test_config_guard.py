...
class ConfigGuardTests(unittest.TestCase):
    def test_rejects_missing_jwt_secret_in_production(self):
        with self.assertRaisesRegex(RuntimeError, "NEXUS_JWT_SECRET"):
    ...
    def test_allows_dev_secret_only_outside_production(self):
        ...
        self.assertEqual(secret, "dev_only_change_me_nexus_jwt_secret")
    ...
    def test_rejects_remote_bind_without_lan_auth(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "NEXUS_LAN_AUTH"):
    ...
    def test_rejects_remote_bind_without_strong_lan_token(self):
        ...
        with self.assertRaisesRegex(RuntimeError, "NEXUS_LAN_TOKEN"):
            validate_lan_security(config)
    ...
    def test_openai_provider_requires_key(self):
        with patch.dict(
            os.environ,
            {"NEXUS_LLM_PROVIDER": "openai", "OPENAI_API_KEY": ""},
            clear=True,
        ):
    ...
    def test_hosted_ollama_api_requires_api_key(self):
        env = {
            ...
            "NEXUS_LLM_URL": "https://ollama.com/api/chat",
            "OLLAMA_API_KEY": "",
            "NEXUS_LLM_API_KEY": "",
        }
    ...
    def test_config_diagnostics_do_not_expose_secret_values(self):
        env = {
            "NEXUS_ENV": "prod",
            "NEXUS_ALLOW_INSECURE_DEV_SECRET": "1",
            "NEXUS_LLM_PROVIDER": "ollama",
            "NEXUS_LLM_URL": "https://ollama.com/api/chat",
